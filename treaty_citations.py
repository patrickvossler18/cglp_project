...
def getTreatyData(text,regex_df,treaty_names,file,country_df,country_name=None,year=None):
    '''
    Inputs:
...
def insertTreatyData(country_name,year,file,fileText,regex_df,treaty_names,mysql_table,connection_info,country_df,file):
    ...
    '''     
    try:
        treatyData = getTreatyData(text=fileText,country_name=country_name,year=year,regex_df=regex_df,treaty_names=treaty_names,file=file,country_df=country_df)
