        ...
        for year, folder in countryFiles.items():
            ...
            for file in tqdm(folder):
                try:
                    ...
                    soft_law_citations.insertSoftLawData(country,year,file,fileText,soft_law_regex_df,softlaw_names,TABLE_NAME,ENGINE,country_df)
                    intl_court_citations.insertIntlCourtData(country,year,file,fileText,intl_court_regex_df,intl_court_names,TABLE_NAME,ENGINE,country_df)
                    treaty_citations.insertTreatyData(country,year,file,fileText,treaties_regex_df,treaty_names,TABLE_NAME,ENGINE,country_df)
                    foreign_court_citations.insertForeignCourtsData(country,year,file,fileText,fc_regex_df,fc_country_names,fc_court_names,TABLE_NAME,ENGINE,country_df)
                except Exception, e:
                    print e
                    pass
